...
public class Cell extends FrameLayout {
    ...
    public FrameLayout.LayoutParams createFrameLayoutParams() {
        int cellMargin = (int) (displayWidth*1.2/100); // Cell margin amount equals to the 3% of the displayWidth
        int cellSize = (int) ((displayWidth - cellMargin * 14) / 7.7); // Cell size equals to the displayWidth minus Cell Margin * 14 (because of left and right margins) divided by the amount of pegs (7)
